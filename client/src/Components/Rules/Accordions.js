        ...
        <Accordion className="accordion">
          ...
          <AccordionDetails>
            <ul className="list">
              ...
              <li className="item">
                Once the server strikes the ball, players may go any where they
                choose.
              </li>
              <li className="item">
              ...
              <li className="item">
                Determine a serving order which alternates players from the two
                teams (e.g. Player 3 follows Player 1, etc.).
              </li>
              <li className="item">
      ...
      <div className={classes.root}>
        <Accordion className="accordion">
          ...
          <AccordionDetails>
            <ul className="list">
              <li className="item">
                Roundnet is played using tally scoring; points can be won by the
              ...
              <li className="item">
                Games must be won by two points unless otherwise agreed upon or
                specified.
              </li>
              <li className="item">
                ...
                <ul className="list-list">
                  ...
                  <li className="item">
                    The ball is hit directly into the rim at any time,including
                    on a serve.
                  </li>
                  <li className="item">
      ...
      <div className={classes.root}>
        <Accordion className="accordion">
          ...
          <AccordionDetails>
            <ul className="list">
              <li className="item">
                If the receiving team wins the point, the next designated player
                serves according to the initial sequence. Otherwise, the server
                switches places with his/her partner and serves to the other
                receiving team member.
              </li>
              <li className="item">
                The receiving team sets their position first. The server stands
                180 degrees across the designated receiver--the only player
                allowed to field the serve.
              </li>
              <li className="item">
                Serves may be struck with any amount of force; short serves are
                allowed.
              </li>
              <li className="item">
                ...
                <ul className="list-list">
                  ...
                  <li className="item">
                    If the server tosses the ball, he/she must hit it. Dropping,
                    catching, or swinging at and missing a toss all count as a
                    fault.
                  </li>
                </ul>
              </li>
      ...
      <div className={classes.root}>
        <Accordion className="accordion">
          ...
          <AccordionDetails>
            <ul className="list">
              <li className="item">
                Touches must alternate between teammates. Consecutive touches by
                one player result in a loss of a point.
              </li>
              <li className="item">
              ...
              <li className="item">
                After the serve, any unusual bounce (i.e. pocket) that does not
                contact the rim is legal and playable.
              </li>
              <li className="item">
